...
const UsersLists = ({ filteredUsers, currentUser, friendRequests, setFriendRequests, sentRequests, setSentRequests, friends, setFriends }) => {
        ...
        const fetchFriends = async () => {
            ...
            for (const user of filteredUsers) {
                try {
                    ...
                    const response = await axios.post(`${window.location.origin}/api/users/friends`, {
    ...
    const sendFriendRequest = async (receiverEmail) => {
        try {
            await axios.post(`${window.location.origin}/api/users/sendrequest`, {
    ...
    const removeFriendRequest = async (receiverEmail) => {
        try {
            await axios.post(`${window.location.origin}/api/users/remove-request`, {
                senderEmail: currentUser,
                receiverEmail: receiverEmail,
            });
    ...
    const acceptFriendRequest = async (requestSenderEmail) => {
        try {
            const response = await axios.post(`${window.location.origin}/api/users/accept-request`, {
    ...
    const removeFriend = async (friendEmail) => {
        try {
            await axios.post(`${window.location.origin}/api/users/remove-friend`, {
                currentUserEmail: currentUser,
